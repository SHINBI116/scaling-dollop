...
public class E07_File {
	/*
	 	...
	 	- 있는 파일의 정보를 담을 수도 있고
	 	  아직 존재하지 않는 파일의 정보를 만들어 놓고 생성할 수도 있다
	...
	public static void main(String[] args) {
		...
		System.out.println(f4.exists()); // 폴더도 파일로서 선택O
		...
		/*
		 	...
		 	C:\aiaumation_LSB\JAVA_workspace\JavaStudy\myfiles\test.txt
		 	C:/java/workspace/src - 절대경로
		 	
		 	./myfiles/emails.txt - 상대경로
		 */
		File ff1 = new File("C:/aiaumation_LSB/JAVA_workspace/JavaStudy/myfiles/emails.txt");
		...
		// mkdirs() : 해당 파일을 만들기 위한 부모폴더까지 모두 만들어버린다
		if (!ff4.exists()) {
			ff4.mkdirs();
		}
		...
		for (String fileName : fileNames) {
			// 하나씩 꺼낸 자식파일들의 이름으로 또 파일 객체를 생성
		...
		// listFiles() : 폴더 안의 내용을 File[]로 꺼내준다
