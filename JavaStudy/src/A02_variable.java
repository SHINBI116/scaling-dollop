...
public class A02_variable {
	...
	/*
	  ...
	  -주로 어떤 프로그램으로 '저장하기' 기능을 수행했을 때 보조기억장치에 해당 데이터 보관
	  ...
	  -원래 알고있던 =의 의미 :왼쪽의 값과 오른쪾의 값이 같다
	...
	//만약 main() 한뭇에 틀린점이 있다면 가장 최근에 성공했던 main을 대신 실행
	public static void main(String[] args) {
		...
		com_score+"점입니다.");
		System.out.println("현재설정된인사말: "+goodbye);
		System.out.println("현재설정된환영메시지:"+welcome);
		...
		byte by=2; int in =by; System.out.println(in);
