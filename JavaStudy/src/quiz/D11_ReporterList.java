...
public class D11_ReporterList {
	...
	/*
	 	1. 어떤 이메일 도메인(yna.co.kr, hankyung.com ..) 이 몇 개씩 있는지 세어서 출력해보기
	 	
	 	2. 어떤 신문사의 기자가 몇 명씩 있는지 세어서 출력해보기
	 	
	 	3. 어떤 분야의 기자가 몇 명씩 있는지 세어서 출력
	 	
	 	4. 모든 기자의 이름/이메일/분야을 신문사별로 분류하여 출력해주기
	...
	public static void main(String[] args) {
		...
		// MAp : 키와 값을 저장할 수 있는것
		// categoryCompanyMap : 키갑으로 회사의 이름을 쓰고 값으로 리스트를 사용
		...
		for (Reporter reporter : reporters) {
			...
			if (categoryField.containsKey(field)) {
				...
				ArrayList<Reporter> list2 = new ArrayList<>();
				list2.add(reporter);
				categoryField.put(field, list2);
			}
		}
