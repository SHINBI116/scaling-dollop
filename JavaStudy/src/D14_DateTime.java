...
public class D14_DateTime {
	...
	public static void main(String[] args) {
		...
		// 캘린더처럼 원본처럼 훼손하는것이 아니라 새로운 인스턴스를 만들어 낸다
		...
		System.out.println("10일 뒤 날짜 : " + now_dt.plusDays(10).getDayOfMonth());
...
//		}
		...
		// with 메서드와 함께
		// TemporalAdjusters의 여러 시간 조절기들을 꺼내 쓸 수 있다 
		System.out.println("어린이날 포함된 달의 마지막 날짜 : " + childrensDay.with(TemporalAdjusters.lastDayOfMonth()));
