...
// (해적통은 Shuffleable 인터페이스를 구현받았으므로 섞을 수 있는 객체가 되었다)
class PirateBarrel implements Shuffleable {
...
class OneCard implements Shuffleable {
