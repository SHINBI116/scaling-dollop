...
public class A06_print {
	...
	/*
	 ...
	 데이터가 들어가야 하는 자리에 데이터를 순서대로 채워서 사용
	 ...
	 * printf()에 사용할 수 있는 서식 문자의 종류
	   ...
	   %s :문자열
	   %c :문자
	   %% :그냥 %f를 출력하고 싶은 경우(서식 문자 escape)
	   
	   * 서식문자옵션 - 서식 문자의 %와 문자 사이에 넣어서 사용
	...
	public static void main(String[] args) {
		...
		System.out.printf("15의 16진수 소문자로 표현하면 ? %x\n",15);
		System.out.printf("15의 16진수 대문자로 표현하면 ? %X\n",15);
		
		System.out.printf("%f\n",12.12345f);
		System.out.printf("%s\n","문자열");
		System.out.printf("%c등급\n",'A');
		System.out.printf("%8s%8s%8s%8s\n", "alice","chloe","erin","jade"); //8칸 확보 너비 확보 ex.
