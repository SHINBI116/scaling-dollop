...
public class D09_String {
	public static void main(String[] args) {
		...
		// "".split(기준(delim)) : 문자열을 원하는 문자를 기준으로 자른 배열을 반환
		...
		// : iterable(하나씩 꺼낼 수 있는) 객체를 원하는 기준으로 모두 이어붙인 하나의 문자열을 생성
		...
		// "".toUpperCase() : 해당 문자열을 모두 대문자로 변환한 새 인스턴스로 반환
		// "".toLowerCase() : 해당 문자열을 모두 소문자로 변환한 새 인스턴스로 반환
		String cmd = "quit";
		String userCmd = "Quit";
		...
		// "".indextOf(str, start) : 문자열을 어디서부터 찾기 시작할건지 결정할 수 있다
