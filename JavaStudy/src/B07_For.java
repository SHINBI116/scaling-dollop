...
public class B07_For {
	...
	public static void main(String[] args) {
		/*
		 	...
		 	- 초기값에는 0을 주고 조건에는 반복하고 싶은 횟수를 적는 반식
		 	- 증가는 1씩 진행하는 방식
...
//		}
		...
		//<연습> byte 타입의 모든 값을 최소값부터 최대값까지 출력해보세요
...
//		}
//		System.out.println();
//		//byte타입 오버플로우 128이 없어서 무한반복
//		//<연습> char 타입의 모든 문자를 최소값부터 최대값까지 출력해보세요
//		
//		for (int i = 0; i <= 65536; ++i ) {
//			//System.out.printf("%d번째 문자 '%c'\n" , i, (char) i);
//			//System.out.println((int)i + "번째 문자" + i);
//		}
