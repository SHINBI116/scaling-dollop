...
public class B14_Array2 {
	...
	public static void main(String[] args) {
		...
		// int[][]의 값을 인덱스르 통해 꺼내면 int[]이 나온다
		...
		// - 배열타입 변수에는 실제 배열의 메모릴상 위치(주소값)이 들어있고
		...
		// n차원 배열은 n중 반복문을 모든 요소를 탐색할 수 있다
		...
		//연습 : message에 포함된 모든 요소를 반복문으로 하나씩 출력해보세요
		
		char[][][] messages = {negativeMessages, positiveMessage };
