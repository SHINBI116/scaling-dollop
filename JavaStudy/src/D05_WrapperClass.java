...
public class D05_WrapperClass {
	...
	*/
	public static void main(String[] args) {
		...
		double doubleVaule = Double.parseDouble(value);
		...
		System.out.println("대문자인가요? " + Character.isLowerCase('D'));
		...
		// (타입 번호는 Character 클래슨 내부에 상수로 선언되어 있다)
